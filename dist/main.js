...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst api = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/SISlsj4W9saMade7JXRU/scores/';\r\n\r\nconst submitScore = (userName, userScore) => fetch(api, {\r\n  method: 'POST',\r\n  headers: {\r\n    'Content-type': 'application/json',\r\n  },\r\n  body: JSON.stringify({\r\n    user: userName,\r\n    score: userScore,\r\n  }),\r\n}).then((res) => res.json());\r\n\r\nconst refreshScore = () => fetch(api)\r\n  .then((res) => res.json())\r\n  .then((res) => res.result);\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({ submitScore, refreshScore });\r\n\n\n//# sourceURL=webpack://leaderboard/./src/leaderBoard.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"render\": () => (/* binding */ render)\n/* harmony export */ });\n/* harmony import */ var _leaderBoard_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./leaderBoard.js */ \"./src/leaderBoard.js\");\n/* harmony import */ var _variables_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./variables.js */ \"./src/variables.js\");\n\r\n\r\n\r\nconst render = async () => {\r\n  const scoreOfPlayers = await _leaderBoard_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].refreshScore();\r\n  _variables_js__WEBPACK_IMPORTED_MODULE_1__.renderSection.innerHTML = \"\";\r\n  for (let i = 0; i < scoreOfPlayers?.length; i += 1) {\r\n    _variables_js__WEBPACK_IMPORTED_MODULE_1__.renderSection.innerHTML += `<li d-flex input-list><span>${scoreOfPlayers[i].user} : </span> <span>${scoreOfPlayers[i].score}</span> </li>`;\r\n  }\r\n};\r\n //eslint-disable-line\r\n\n\n//# sourceURL=webpack://leaderboard/./src/render.js?");
